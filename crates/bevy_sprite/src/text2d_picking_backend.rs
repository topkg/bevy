...
impl Plugin for Text2dPickingPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(PreUpdate, text2d_picking.in_set(PickingSystems::Backend));
    }
}
...
pub fn text2d_picking(
    ...
    radsort::sort_by_key(&mut sorted_text2d, |(_, _, _, transform, _)| {
        ...
        let picks: Vec<(Entity, HitData)> = sorted_text2d
            ...
            .filter_map(
                |(entity, text_layout_info, anchor, text2d_transform, picking_behavior)| {
                    ...
                    blocked = is_cursor_in_text2d && picking_behavior.should_block_lower;
